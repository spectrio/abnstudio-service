...
class JIRA //implements JIRAContract
{
    ...
    public function createIssue($mtid, $acct, $acctName, $username, $playlists=array(), $url)
    {
        $this->check_login();
        ...
        $datetime = date('Y-m-d\TH:i:s.\0\0\0\Z', strtotime('now'));
...
Account: $acct\n
Channels: $playlists"; //Paragraph
        //$data['fields']['customfield_10716'] = ''; //Spot Start Date YYYY-MM-DDThh:mm:ss.sTZD
        //$data['fields']['customfield_10717'] = ''; //Spot End Date YYYY-MM-DDThh:mm:ss.sTZD
